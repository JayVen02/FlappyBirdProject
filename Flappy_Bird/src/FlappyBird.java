...
public class FlappyBird implements ActionListener, KeyListener{
	...
	private BufferedImage pipeImage, birdImage;
...
//	Image image = new ImageIcon(this.getClass().getResource("images/fpblue.png")).getImage();


	public FlappyBird() {
//		URL birdLocation = getClass().getResource("fpblue.png");
//		birdImage = new ImageIcon();

//		URL pipeLocation = getClass().getResource(" ");

//		try{
//			pipeImage = ImageIO.read(pipeLocation);
//		}catch (IOException e){
//			e.printStackTrace();
//		}
			...
			bird = new Rectangle(WIDTH / 2 - 20, HEIGHT / 2 - 10, 20, 20); //coordinate of the Bird in the starting
